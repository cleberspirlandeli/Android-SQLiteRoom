...
import com.example.beta.databinding.FragmentConfirmadoBinding
...
class ConfirmadoFragment : Fragment() {
    ...
    private var _binding: FragmentConfirmadoBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, s: Bundle?): View? {
        ...
        _binding = FragmentConfirmadoBinding.inflate(inflater, container, false)
        val root: View = binding.root

        /** RecyclerView */
        // 1 - Obter a recycler
        val recycler = root.findViewById<RecyclerView>(R.id.recycler_confirmados)
        ...
        _listener = object : ModelListener {
            ...
            override fun OnRemove(dto: Model) {
                ...
                _viewModel.BuscarTodos(ModelConstants.FILTER.CONFIRMADOS)
            }
