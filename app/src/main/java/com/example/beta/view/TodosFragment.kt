...
import com.example.beta.databinding.FragmentTodosBinding
...
class TodosFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, s: Bundle?): View? {
        ...
        /** RecyclerView */
        // 1 - Obter a recycler
        val recycler = root.findViewById<RecyclerView>(R.id.recycler_todos)
        ...
        _listener = object : ModelListener {
            ...
            override fun OnRemove(dto: Model) {
                ...
                _viewModel.BuscarTodos(ModelConstants.FILTER.TODOS)
            }
